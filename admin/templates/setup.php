...
<label>
	...
	- create a database dump for backup<Br>
	- create tables (if not exists)<br>
	- insert missing table columns (changes to the datatype are not checked, deleting unused columns currently disabled for safety: do it with sqlbuddy by hand)<Br>
</label>
