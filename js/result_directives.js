...
app.directive("percentage",function($localStorage,$timeout){
    return {
        restrict:"A",
        template:"<div id='perc' ng-show='pshow'><span>{{pp}}</span><div id='bar' ng-style='{width:pp}'></div></div><span ng-hide='pshow'>Det verkar som att du har valt <i>ingen färg</i> för alla bokstäver och siffror. Tyvärr kan vi inte beräkna en poäng då, men det är inte sannolikt att du har denna typ av synestesi..</span>",
        link:function(s,el,a){
